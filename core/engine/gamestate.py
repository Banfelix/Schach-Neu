...
class GameState:
    def __init__(self):
        ...
        self.halfmoves = 0               # One Fullmove is two halfmoves             # Gets updated during the game         # 50 Halfmoves witout Pawn moves or captures is a draw

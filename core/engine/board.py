...
class Board:
    ...
    def resetToFEN(self, fen):
        self.__init__(fen)  # Reinitalise the board with FEN arg, used for Perft test
    ...
    def printBoard(self):
        ...
        debug_info = [self.gamestate.fullmoves, self.gamestate.halfmoves, self.gamestate.white_kingsidecastle_rights, 
                    self.gamestate.white_queensidecastle_rights, self.gamestate.black_kingsidecastle_rights, self.gamestate.black_kingsidecastle_rights,
                    self.gamestate.enpassant_square, self.gamestate.active_color]
        debug_info_name = ["Current Fullmove: ", "50-Move counter: ", "White Kingside Castlerights:", "White Queenside Castlerights: ", "Black Kingside Castlerights: ","White Queenside Castlerights: ", "En Passant Square: ", "Active Color:"]
        i = 0
    ...
    def makeMove(self, move):
        ...
        self.updateCastlingRights(moving_piece, start_square, end_square)
    ...
    def updateCastlingRights(self, moving_piece, start_square, end_square):
        # See if either king or rook was moved
    ...
    def unMakeMove(self):
        ...
        end_square, start_square, flag = Move.moveDecode(move)  # End and Start inverted, like making a move but from end to start of the last move. Restore all states
